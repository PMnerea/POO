		...
		public InetAddress getUserByPseudo(String pseudo) {
			...
			try {
				...
				if (rs.next()) {
					...
					System.out.println("SE HER IPPPPP :  " + addName);
					String[] res = addName.split("/");
					try {
						InetAddress ipAdd = InetAddress.getByName(res[1]);
						System.out.println("[LocalDB] IP address returned : " + res[1]);
						System.out.println("[LocalDB] IP address returned : " + ipAdd);
						System.out.println(" ================================= ");
						return ipAdd;
